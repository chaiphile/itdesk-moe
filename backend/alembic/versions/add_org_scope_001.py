...
def upgrade() -> None:
    ...
    op.create_foreign_key('fk_users_org_unit', 'users', 'org_units', ['org_unit_id'], ['id'])
    op.add_column('users', sa.Column('scope_level', sa.String(), nullable=False, server_default='SELF'))
