...
def upgrade() -> None:
    ...
    if "attachments" in tables:
        ...
        if "retention_days" not in columns:
            op.add_column(
                "attachments", sa.Column("retention_days", sa.Integer(), nullable=True)
            )
...
def downgrade() -> None:
    ...
    if "attachments" in tables:
        ...
        try:
            op.drop_constraint(
                "ck_attachments_sensitivity_vals", "attachments", type_="check"
            )
        except Exception:
            pass
        ...
        try:
            op.drop_constraint(
                "ck_attachments_status_vals", "attachments", type_="check"
            )
        except Exception:
            pass
